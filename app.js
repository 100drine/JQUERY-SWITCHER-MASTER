...
function main(){
	...
	*/
    ...
    /*
    $('#ui button').on('click'."cat", function()) 
    {var callback = $ (this).attr ('data-animal')
    img ="data-animal" src="cat.jpg"};
    
});*/
    
    $(".ui button").click(function()) {   /*fonction click*/
    var callback = $(this).data("animal");   /*recuperation du data dans le callback*/
    $(this).find('cat.jpg' 'bear.jpg' 'fish.jpg').attr('animal'); /*species*/
    <img id="animal" src="cat.jpg" />
    <img id="animal" src="bear.jpg" />
    <img id="animal" src="fish.jpg" />
   });
